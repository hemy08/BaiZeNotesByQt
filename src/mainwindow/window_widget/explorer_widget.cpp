...
namespace HMainLayOut
{
    ...
    void HemyExplorerWidget::setTitle(const QString &title) const
    {
        m_titleLabel->setText(QString("<h1>%1</h1>").arg(title));
    }

    void HemyExplorerWidget::addExplorer(QWidget *widget) const
    {
        m_layout->insertWidget(m_layout->count() - 1, widget);
    }

    void HemyExplorerWidget::clearExplorer() const
    {
        QLayoutItem *child;
